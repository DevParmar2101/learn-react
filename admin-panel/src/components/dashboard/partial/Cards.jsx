        ...
        <div className="owl-carousel counter-carousel owl-theme">
                ...
                <div className="card border-0 zoom-in bg-light-primary shadow-none">
                    <div className="card-body">
                        <div className="text-center">
                            <img src="./src/assets/images/svgs/icon-user-male.svg" width="50" height="50" className="mb-3"
                                 alt=""/>
            ...
            <div className="item">
                <div className="card border-0 zoom-in bg-light-warning shadow-none">
                    <div className="card-body">
                        <div className="text-center">
                            <img src="./src/assets/images/svgs/icon-briefcase.svg" width="50" height="50" className="mb-3"
                                 alt=""/>
            ...
            <div className="item">
                <div className="card border-0 zoom-in bg-light-danger shadow-none">
                    <div className="card-body">
                        <div className="text-center">
                            <img src="../src/assets/images/svgs/icon-favorites.svg" width="50" height="50" className="mb-3"
                                 alt=""/>
            ...
            <div className="item">
                <div className="card border-0 zoom-in bg-light-success shadow-none">
                    <div className="card-body">
                        <div className="text-center">
                            <img src="./src/assets/images/svgs/icon-speech-bubble.svg" width="50" height="50"
                                 className="mb-3" alt=""/>
            ...
            <div className="item">
                <div className="card border-0 zoom-in bg-light-info shadow-none">
                    <div className="card-body">
                        <div className="text-center">
                            <img src="./src/assets/images/svgs/icon-connect.svg" width="50" height="50" className="mb-3"
                                 alt=""/>
