    ...
    return (
        <form>
            ...
            <div className="d-flex align-items-center justify-content-between mb-4">
                ...
                <a className="text-primary fw-medium" href="./authentication-forgot-password.html">Forgot
                    Password ?</a>
            </div>
            ...
            <div className="d-flex align-items-center justify-content-center">
                ...
                <a className="text-primary fw-medium ms-2" href="./authentication-register.html">Create
                    an account</a>
            </div>
        </form>
